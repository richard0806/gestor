...
<body>
	...
	<article class="container" style="padding-top:50px;" id="accordion">
                            ...
                            <div class="input-group-btn input-group-select">
                                ...
                                <span class="concept">Gesman</span> <span class="caret"></span>
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        ...
                                        <li class="hidden"><a href="#SNO" class="noOficial">SNO</a></li>
                                    </ul>
		...
		<hr style="border-color:#333;">
		<div class="col-md-10">
				<textarea name="comentarios" class="form-control" rows="3" cols="30"></textarea>
		</div>
		<div style="text-align:right;">
	    	<button type="button" class="btn btn-sm btn-primary" id="submit"><i class="fa fa-tasks"></i> Procesar</button>
	    	<button type="reset" class="btn btn-sm btn-default"><i class="fa fa-ban"></i> Cancelar</button>
	    </div>
		</div>
	</article>
