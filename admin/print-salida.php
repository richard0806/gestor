...
<div class="container">
    ...
    <?php
      ...
      $query2 = $con->query("SELECT * FROM tbl_salida WHERE ot = '{$_GET["ot"]}' LIMIT 1");
      	     $nosalida = '';
		  $observaciones = '';
    ...
    <div id="tabla-detalle" style="margin-top:5px">
        <table class="table table-bordered table-condensed table-responsive" style="margin-bottom: 0;">
          <tr>
            ...
            <?php
    		 	$consulta0 = "SELECT * FROM tbl_sdetalles WHERE id_salida = '{$nosalida}' ";
          ...
          <tr>
            ...
            <td><?= $medida; ?></td>
            <td><?= $rows['cantidad']; ?></td>
            <td>(<?= $rows['Condicion'] ?>)</td><!--/Campo Comentario crear bd/-->
          </tr>
          <?php
