...
<html>	
	...
	<body>
      ...
      <div class="container">
      	<div class="jumbotron">
            <h1>Salida Oficial de Productos</h1>
             ...
             <table class="table table-bordered table-condensed table-hover table-responsive" id="detalle-salida">
                <thead bgcolor="#cccccc"> <tr>
                 ...
                 <tbody id="detalle-salida-cuerpo">
                  ...
                  <tfoot>
                	<tr>
                    	<td colspan="9" style="text-align:right; font-size:12px; background-color: #666; color:#FFF;"><strong>Cantidad:</strong> <span id="span_cantidad" class="zoom"></span> Productos.</td>
                    </tr>
                </tfoot>
             </table>
            </div>             
