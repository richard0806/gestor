	...
	<div class="side-menu">
				...
				<ul class="nav navbar-nav admin-menu">
                    ...
                    <li class="panel panel-default" id="dropdown">
						<a data-toggle="collapse" href="#dropdown-lvl6">
							<span class="fa fa-book fa-fw"></span>Inventario<span class="caret"></span>
						</a>
						<!-- Dropdown level 1 -->
						<div id="dropdown-lvl6" class="panel-collapse collapse">
							<div class="panel-body">
								<ul class="nav navbar-nav">
									<li><a data-target-id="Inv_xAlm"><i class="fa fa-book fa-fw"></i>Por Almacén</a></li>
									<li><a data-target-id=""><i class="fa fa-book fa-fw"></i>asignar</a></li>
									<li><a href="#">Por AT</a></li>
                                    <li><a href="#">Por Almacén</a></li>
								</ul>
							</div>
        ...
        <div class="col-md-9 admin-content" id="salidas_xfechas">
        	...
        	<div class="form-group">
                ...
                <div class="col-sm-1">
                <button type="submit" class="btn btn-primary btn-sm btn3d">Generar reporte</button>
                </div>
            </div>
            <hr class="divider">
        </form>
        ...
        <div class="col-md-9 admin-content" id="Inv_xAlm">
        	<form method="post" action="" id="Inv_xAlm" class="form-horizontal">
            	<div class="form-group">
        ...
        <button type="button" class="btn btn-primary btn-sm btn3d"><span class="glyphicon glyphicon-cloud"></span> Generar Reporte</button>
                     </div>
            	</div>
            </form>
        </div>
